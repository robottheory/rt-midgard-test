...
create temporary view member_details as select distinct on(pool, member_addr)
	...
	coalesce(last_value(m2m_added_asset_in_rune_e8) over wnd, 0) as m2m_added_asset_in_rune,
	coalesce(last_value(m2m_added_rune_in_asset_e8) over wnd, 0) as m2m_added_rune_in_asset,
	coalesce(last_value(m2m_withdrawn_asset_in_rune_e8) over wnd, 0) as m2m_withdrawn_asset_in_rune,
	coalesce(last_value(m2m_withdrawn_rune_in_asset_e8) over wnd, 0) as m2m_withdrawn_rune_in_asset,
...
create temporary view last_pool_depths as select
	 ...
	 cast(rune_e8 as decimal) / asset_e8 as asset_price_rune_e8
 from (
